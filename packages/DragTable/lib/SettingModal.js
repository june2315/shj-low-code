...
exports.default = exports.insertOfIndex = void 0;
...
var _shjFuncDialog = _interopRequireDefault(require('shj-func-dialog'));
...
var SettingModal = function SettingModal(config) {
  ...
  var dialog = (0, _shjFuncDialog.default)(
    _objectSpread(
      {
        title: '设置',
        content: /*#__PURE__*/ _react.default.createElement(
          ...
          /*#__PURE__*/ _react.default.createElement(TableSetting, {
            data: {
              left: left,
              right: right,
              notFixed: notFixed,
...
var insertOfIndex = function insertOfIndex(arr, el) {
...
exports.insertOfIndex = insertOfIndex;
...
var TableSetting = function TableSetting(props) {
  ...
  var moveCard = (0, _react.useCallback)(
  ...
  var setVisible = (0, _react.useCallback)(
  ...
  var setFixed = (0, _react.useCallback)(
