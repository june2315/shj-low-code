...
var _SettingModal = _interopRequireDefault(require('./SettingModal'));
...
var DragTable = /*#__PURE__*/ (0, _react.forwardRef)(function (props, ref) {
  ...
  var initState = (0, _react.useRef)({});
  var wrapRef = (0, _react.useRef)({});
  var tableContainer = (0, _react.useRef)({});
  var tableBody = (0, _react.useRef)({});
  var tableHeader = (0, _react.useRef)({});
  var tableHeaderScroller = (0, _react.useRef)({});
  var allCheckbox = (0, _react.useRef)({});
  var fixedLeft = (0, _react.useRef)([]);
  var fixedRight = (0, _react.useRef)([]);
  var notFixed = (0, _react.useRef)([]);
  var hiddenColumns = (0, _react.useRef)([]);
  var defaultColumns = (0, _react.useRef)(null);
  var rowSelect = (0, _react.useRef)();
  var settingRef = (0, _react.useRef)();
  var debounceTimer = (0, _react.useRef)();
  var resizeRef = (0, _react.useRef)({});
  var scrollHandle = (0, _react.useRef)();
  var cacheHash = (0, _react.useRef)(
    'table_columns_'.concat(cacheKey + location.pathname),
  );
  ...
  (0, _react.useImperativeHandle)(ref, function () {
    return {
      openSetting: function openSetting() {
        settingRef.current = (0, _SettingModal.default)({
  ...
  var toggleSelect = (0, _react.useCallback)(
    ...
    /*#__PURE__*/ _react.default.createElement(
                  ...
                  return !d.width || d.type === 'selection'
                    ...
                    : /*#__PURE__*/ _react.default.createElement(
                        _reactResizable.Resizable,
                        {
                          ...
                          width: d.width,
                          height: 0,
                          handle: /*#__PURE__*/ _react.default.createElement(
                            'div',
                            {
      ...
      !data.length
        ? /*#__PURE__*/ _react.default.createElement(
            ...
            /*#__PURE__*/ _react.default.createElement(_Icon.Empty, null),
            /*#__PURE__*/ _react.default.createElement(
              'div',
              {
