...
export function renderAddonFormItem(text, options, dom, addonProps) {
...
export function FormTreeSelect(props) {
...
export function FormCascader(props) {
...
export var FormAutoDatePicker = /*#__PURE__*/ (function (_React$Component) {
...
export default function SearchForm(props) {
  ...
  var _ref = (props.form && [props.form]) || _Form.useForm(),
  ...
  items.forEach(function (item, index) {
    ...
    if (actionBtnPosition === 'top' && !actionAdd && totalSpan + colSpan > 24) {
      itemsWithInfo.push({
        span: spanSize.span,
        element: /*#__PURE__*/ React.createElement(ActionItem, null),
        key: 'action_item',
      });
      actionAdd = true;
    ...
    itemsWithInfo.push({
      span: colSpan,
      element: item,
      key: /*#__PURE__*/ React.isValidElement(item)
        ? item.key ||
          ''
            .concat(
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        itemsWithInfo.map(function (item, index) {
          if (/*#__PURE__*/ React.isValidElement(item.element) && item.hidden) {
          ...
          var colItem = /*#__PURE__*/ React.createElement(
            _Col,
            {
              key: item.key,
              span: item.span,
            },
            /*#__PURE__*/ React.cloneElement(item.element, {
              form: form,
            }),
        ...
        actionBtnPosition === 'top'
          ? null
          : /*#__PURE__*/ React.createElement(ActionItem, null),
      ),
    ),
  );
}
